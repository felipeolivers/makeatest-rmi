...
@MakeATestReader(reader=RemoveMockRMIReader.class,proxyBehavior={MakeATestProxyBehavior.AFTER},scope=MakeATestScope.PROXYMETHOD)
public @interface RemoveMockRMI { 
	String serverName();
} 