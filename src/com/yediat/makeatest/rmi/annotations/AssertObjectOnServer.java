...
@MakeATestReader(reader=AssertObjectOnServerReader.class,proxyBehavior={MakeATestProxyBehavior.AFTER},scope=MakeATestScope.PROXYMETHOD)
public @interface AssertObjectOnServer {
	String fixtureName();
	String serverName();
}